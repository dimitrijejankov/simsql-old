 ...
 *
 */
public class BaseLineRandomTableStatement extends RandomTableStatement {
	 ...
	 */
	public BaseLineRandomTableStatement(DefinedTableSchema tableAttributes,
			SQLExpression outerTable, ArrayList<WithStatement> withList,
			SelectStatement selectStatement) {
		super(tableAttributes, outerTable, withList, selectStatement);
	}
	
	public BaseLineRandomTableStatement(String indexString,
			DefinedTableSchema tableAttributes,
			SQLExpression outerTable, ArrayList<WithStatement> withList,
			SelectStatement selectStatement)
	{
		super(tableAttributes, outerTable, withList, selectStatement);
	...
	public boolean acceptVisitor(BaseLineRandomTableTypeChecker astVisitor)throws Exception
	{
		return astVisitor.visitBaseLineRandomTableStatement(this);
	}
}
