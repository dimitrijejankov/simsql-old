...
/**
 * Represents a string expression in the AST
 */
public class StringExpression extends MathExpression {
    ...
    @JsonCreator
	public StringExpression(@JsonProperty("value") String value)
	{
     ...
     * @return the type of the expression (string type)
    ...
    /**
     * Returns the value of the string expression
     * @return the value
     */
	@Override
