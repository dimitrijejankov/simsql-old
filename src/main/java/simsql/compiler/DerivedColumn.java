 ...
 *
 */
public class DerivedColumn extends SQLExpression{
	
	public MathExpression expression;
	public String alias;
	
	public DerivedColumn(MathExpression expression, String alias) {
		super();
	...
	/* (non-Javadoc)
	 * @see vcolumn.VColumn#AcceptVisit(astVisitor.ASTVisitor)
	 */
	@Override
	public boolean acceptVisitor(ASTVisitor astVisitor)throws Exception {
		return astVisitor.visitDerivedColumn(this);
	}
