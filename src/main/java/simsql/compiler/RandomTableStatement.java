 ...
 *
 */
public class RandomTableStatement extends Expression{

	public DefinedTableSchema definedTableSchema;
	public SQLExpression outerTable;
	public ArrayList<WithStatement> withList;
	...
	public RandomTableStatement(DefinedTableSchema schema,
								SQLExpression outerTable, 
								ArrayList<WithStatement> withList,
								SelectStatement selectStatement)
	{
		super();
		this.definedTableSchema = schema;
	...
	{
		return astVisitor.visitRandomTableStatement(this);
	}
