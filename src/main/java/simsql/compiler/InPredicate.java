 ...
 *
 */
public class InPredicate extends BooleanPredicate {

	public MathExpression expression;
	public MathExpression setExpression;
	
	
	public InPredicate(MathExpression expression, MathExpression setExpression) {
		super();
	...
	public boolean acceptVisitor(ASTVisitor astVisitor) throws Exception{
		return astVisitor.visitInExpression(this);
	}
