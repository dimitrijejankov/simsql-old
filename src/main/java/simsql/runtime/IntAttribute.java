...
public class IntAttribute implements Attribute {
    ...
    public Attribute add(Matrix addThisIn) {
        ...
        Matrix.nativeAddDouble(addThisIn.getAddress(), 1.0, (double) myVal, m.getAddress());
    ...
    public Attribute subtract(Matrix subtractThisOut) {
        ...
        // add double in native
        Matrix.nativeAddDouble(subtractThisOut.getAddress(), -1.0, myVal, m.getAddress());
    ...
    public Attribute subtractR(Matrix subtractFromMe) {
        ...
        // add double in native
        Matrix.nativeAddDouble(subtractFromMe.getAddress(), 1.0, -myVal, m.getAddress());
    ...
    public Attribute multiply(Matrix byMe) {
        ...
        // add double in native
        Matrix.nativeMultiplyDouble(byMe.getAddress(), myVal, m.getAddress());
    ...
    public Attribute divide(Matrix byMe) {
        ...
        // add double in native
        Matrix.nativeDivideDoubleMatrix(myVal, byMe.getAddress(), m.getAddress());
    ...
    public Attribute divideR(Matrix divideMe) {
        ...
        // add double in native
        Matrix.nativeDivideMatrixDouble(divideMe.getAddress(), myVal, m.getAddress());
