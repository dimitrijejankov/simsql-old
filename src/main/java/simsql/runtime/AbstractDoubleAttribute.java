...
public abstract class AbstractDoubleAttribute implements Attribute {
    ...
    public Attribute add(Matrix addThisIn) {
        ...
        Matrix.nativeAddDouble(addThisIn.getAddress(), 1.0, myVal, m.getAddress());
    ...
    public Attribute divideR(Matrix byMe) {
        // allocate matrix
        Matrix m = new Matrix(byMe.getSize1(), byMe.getSize2(), byMe.getIfRow());

        // add double in native
        Matrix.nativeDivideMatrixDouble(byMe.getAddress(), myVal, m.getAddress());
