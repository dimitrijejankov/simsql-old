...
public class IntType extends AbstractDataType {
	...
	public Compatibility parameterize (DataType withMe, Map <String, Integer> addToMe) {
		...
		else if (withMe.getTypeName().equals("double") || withMe.getTypeName().equals("double random")
				|| withMe.getTypeName().equals("scalar") || withMe.getTypeName().equals("scalar random"))
			return Compatibility.DEMOTABLE;
		else
