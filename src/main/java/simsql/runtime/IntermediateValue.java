...
public class IntermediateValue {
    ...
    private Matrix[] matrixValue = null;
    ...
    public void set(Matrix val, int mc) {
    ...
    public Attribute getAttribute() {
        ...
        switch (type.getTypeCode()) {
            ...
            case MATRIX:
                ...
                return sameSoFar ? new MatrixAttribute(matrixValue[0]) : new NullAttribute();
