...
public interface Attribute extends Serializable {
     ...
     * NULL if there is no valid data for the specified mcIteration
     */
     ...
     */
    byte[] injectValue(int mcIteration);

    void injectIntoBuffer(int mcIteration, AttributeType castTo, LargeByteBuffer buffer);
     ...
     * of bytes read.
     */
    long readSelfFromStream(DataInputStream readFromMe) throws IOException;
    ...
    Attribute add(boolean ifRow, double[][] me);
    ...
    Attribute addR(boolean ifRow, double[][] me);
    ...
    Attribute subtract(boolean ifRow, double[][] me);
    ...
    Attribute subtractR(boolean ifRow, double[][] me);
    ...
    Attribute multiply(boolean ifRow, double[][] me);
    ...
    Attribute divide(boolean ifRow, double[][] me);
    ...
    Attribute divideR(boolean ifRow, double[][] me);
    ...
    Bitstring equals(boolean ifRow, double[][] me);
    ...
    Bitstring notEqual(boolean ifRow, double[][] me);
    ...
    Bitstring greaterThan(boolean ifRow, double[][] me);
    ...
    Bitstring lessThan(boolean ifRow, double[][] me);
    ...
    Bitstring greaterThanOrEqual(boolean ifRow, double[][] me);
    ...
    Bitstring lessThanOrEqual(boolean ifRow, double[][] me);
